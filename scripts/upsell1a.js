...
const prices = [{"name":"VIP Customer Benefits","id":26,"quantity":1,"price":24.99,"shippable":false,"fullPrice":24.99,"finalPrice":24.99,"productName":"VIP Customer Benefits","discountAmount":0,"discountPercentage":0},{"name":"1x USB","id":1794,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"1x USB","discountAmount":0,"discountPercentage":0},{"name":"1x Vital Translate Buds","id":104,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"1x Vital Translate Buds","discountAmount":0,"discountPercentage":0},{"name":"2x Vital Translate Buds","id":105,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"2x Vital Translate Buds","discountAmount":0,"discountPercentage":0},{"name":"3x Vital Translate Buds","id":106,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"3x Vital Translate Buds","discountAmount":0,"discountPercentage":0},{"name":"4x Vital Translate Buds","id":107,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"4x Vital Translate Buds","discountAmount":0,"discountPercentage":0},{"name":"5x Vital Translate Buds","id":108,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"5x Vital Translate Buds","discountAmount":0,"discountPercentage":0},{"name":"Special 1x EXTRA Vital Translate Earbuds","id":111,"quantity":1,"price":0,"shippable":false,"fullPrice":44.99,"finalPrice":44.99,"productName":"Special 1x EXTRA Vital Translate Earbuds","discountAmount":0,"discountPercentage":0},{"name":"Special 1x EXTRA Vital Translate Earbuds","id":112,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Special 1x EXTRA Vital Translate Earbuds","discountAmount":0,"discountPercentage":0},{"name":"Vital Translate Buds  Journey Package Protection","id":110,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Vital Translate Buds  Journey Package Protection","discountAmount":0,"discountPercentage":0},{"name":"Vital Translate Buds - 3 Year Warranty","id":109,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Vital Translate Buds - 3 Year Warranty","discountAmount":0,"discountPercentage":0},{"name":"Vital Translate Buds - Expedited Shipping","id":1547,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Vital Translate Buds - Expedited Shipping","discountAmount":0,"discountPercentage":0}];
...
const runDeclineFlow = async ({ isAutoSkip = false } = {}) => {
  if (!isAutoSkip) {
   MVMT.track("CTA_CLICK", {
    page: "Vital Translate Buds - Upsell1a",
    page_type: "Upsell",
    ...
    const response = await fetch(
      `https://app-cms-api-proxy-prod-001.azurewebsites.net/vrio/order_offers`,
      {
        ...
        body: JSON.stringify({
          ...
          order_id: lastOrderId,
          pageId: "ySlrFxohVyskqbG2vy5DnL6FNUa16SQYb-jgewy9HdW18dpBumua6aW_mNDYAmGO"
        })
      }
    );
...
const processUpsell = async () => {
  ...
  try {
    const orderData = JSON.parse(sessionStorage.getItem("orderData"));
    orderData.pageId = "ySlrFxohVyskqbG2vy5DnL6FNUa16SQYb-jgewy9HdW18dpBumua6aW_mNDYAmGO";
    const lastOrderId = sessionStorage.getItem("cms_oid");
...
if (typeof validateAndSendToKlaviyo === "function") {
  try {
    ...
    var pageReadyPayload = {
      ...
      data: { pageName: "Vital Translate Buds - Upsell1a", pageType: "Upsell" },
    };
